DESCRIPTION = "Linux kernel for vuplus uno"
LICENSE = "GPL"
KV = "2.6.18-7.3"
PV = "2.6.18"
PR = "r7"
...
SRC_URI_GCC44_PATCH = ${@base_contains('PREFERRED_GCC_VERSION', '4.4.3', 'file://linux_vuuno_gcc_4.4.patch;patch=1;pnum=1', '', d)}
...
SRC_URI = "http://archive.vuplus.com/download/stblinux-${KV}.tar.bz2 \
	file://linux_vuuno_nand2.patch;patch=1;pnum=1 \
        ...
        file://linux_vuuno_resource.patch;patch=1;pnum=0 \
        file://linux_vuuno_arch_makefile.patch;patch=1;pnum=0 \
        file://linux_vuuno_kobject.patch;patch=1;pnum=0 \
...
do_configure_prepend() {
	oe_machinstall -m 0644 ${WORKDIR}/vuuno_defconfig ${S}/.config
